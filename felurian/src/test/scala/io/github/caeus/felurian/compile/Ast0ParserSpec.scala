...
import io.github.caeus.felurian.compile.Ast0.Expr.{RefExpr, ValueExpr}
import io.github.caeus.felurian.value.Value.{BoolVal, TextVal}
    ...
    suite("Ast0Parser")(
      ...
      suite("delimited")(
        testParser(
          ...
          Assertion.isRight(Assertion.isSubtype[ValueExpr](Assertion.anything))
        ),
        testParser(
          "float",
          "123.02",
